...
| [0002](0002-domain-boundaries.md) | Directory Domain Boundaries | Unknown | Accepted |
...
| [0024](0024-agent-instructions-reference-adrs.md) | Agent Instructions Are Thin; Constraints Live in `docs/adr/` | Unknown | Accepted |
